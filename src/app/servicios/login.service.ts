...
export class LoginService {
  ...
  login(user: { nombre: string; contrasena: string }): Observable<Inscrito> {
    ...
    return this.http.post<Inscrito>('http://jobseniorback.railway.internal:8080/api/inscritos/login', user);
  }
  ...
  register(user: { nombre: string; contrasena: string }): Observable<Inscrito> {
    ...
    return this.http.post<Inscrito>('http://jobseniorback.railway.internal:8080/api/inscritos/register', user);
  }
